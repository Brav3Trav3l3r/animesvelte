export const styles = {
    navIcons : 'text-xl md:text-2xl text-zinc-100/50 bg-zinc-800/40 hover:bg-zinc-600/40 box-content rounded-md p-2 ',
    primeTitle: 'heading text-4xl xl:text-6xl md:text-5xl  tracking-wide text-purple-50 border-b border-purple-50/50 pb-6 ',
    secTitle:  'text-xl md:text-2xl font-medium tracking-wide text-zinc-400 ml-3',
    triTitle: 'text-purple-100/80 text-sm md:text-base line-clamp-1',

    
    
    para:'line-clamp-4 leading-relaxed text-purple-50/60 px-2 lg:px-0',
