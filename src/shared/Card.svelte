...
<a href={`/a1/${anime.id}`}><div class="card bg-black/50 hover:bg-zinc-800 sm:hover:-translate-y-1 transform duration-200 p-3 pb-4 rounded-lg flex flex-col space-y-3 ">
